#!/bin/bash
#Open HTTP Puncher By matyo123 Project
...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/angahpadu/angahshop786/main/ohp"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By matyo123
Documentation=https://t.me/matyo123
